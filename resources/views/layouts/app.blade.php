...
<head>
  ...
  <!-- summernote -->
  <link rel="stylesheet" href="{{asset('backend/plugins/summernote/summernote-bs4.min.cs')}}">
</head>
...
<script src="{{asset('backend/plugins/jqvmap/maps/jquery.vmap.usa.j')}}s"></script>
<!-- jQuery Knob Chart -->
